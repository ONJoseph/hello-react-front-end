...
```console
git clone https://github.com/ONJoseph/hello-react-front-end.git
```
...
Feel free to check the [issues page](https://github.com/ONJoseph/hello-react-front-end/issues).
